<template>
  <div>
    <el-row style="margin-left: 14%;height: 1%;line-height: 90px" >
      ...
      <el-col :span="5" >
        <el-input type="text" v-model="search" placeholder="学科名" @keyup.native="find"></el-input>
      </el-col>
      <el-col :span="4" >
    ...
    <el-dialog  :visible.sync="editFormVisible" >
      <el-form ref="editForm" :model="editForm" :rules="editRules" label-width="100px" class="demo-ruleForm">
        ...
        <el-form-item  prop="name" :label-width="'10'"  style="width: 25%;margin-left: 35%"  >
          <el-input v-model="editForm.name" type="text"  autocomplete="off" placeholder="学科名" ></el-input>
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
      ...
      <el-table-column header-align="center"
        ...
        <template slot-scope="scope">
          ...
          <el-popconfirm
              ...
              icon="el-icon-info"
              icon-color="red"
              :title="'确定删除 '+scope.row.name+' 这一学科门类吗'"
...
import {addField,editField,getFields,delField} from "@/api/api";
import Vue from 'vue'
export default {
  name: "Fieldmanage",
  data(){
